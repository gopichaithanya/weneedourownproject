...
<form:form method="post" commandName="flightSearchForCustomerCMD" name="flightSearchForCustomerForm">
  <DL>
    <DT><span class="searchFlightForCustomer1StepTitle">Search Flight (1 / <c:out
      value="${totalSteps}" /> steps)</span></DT>
    <DD>
    <table border="1" class="searchFlightForCustomer1step">
      <tbody>
        ...
        <tr>
          ...
          </form:select> <input type="button" value="Calendar" /> <form:errors path="departMonth"
            cssClass="error" /> <form:errors path="departDay" cssClass="error" /> <form:errors
            path="departYear" cssClass="error" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          </form:select> <input type="button" value="Calendar" /> <form:errors path="returnMonth"
            cssClass="error" /> <form:errors path="returnDay" cssClass="error" /> <form:errors
            path="returnYear" cssClass="error" /></td>
        </tr>
        <tr>
    ...
    <c:choose>
      ...
      <c:when test="${step1}">
        <DL>
          <DT><span class="searchFlightForCustomer2StepTitle">Selecting Departing Flight
          (2 / <c:out value="${totalSteps}" /> steps)</span></DT>
          <DD></DD>
          <DT><span class="searchFlightForCustomer3StepTitle">Selecting Returning Flight
          (3 / <c:out value="${totalSteps}" /> steps)</span></DT>
          <DD></DD>
      </c:when>
      ...
      <c:when test="${step2}">
        ...
        <p>
        <DT><span class="searchFlightForCustomer2StepTitle">Choose a departing flight (2
        / <c:out value="${totalSteps}" /> steps)</span></DT>
        <DD>
        <table border="1" class="searchFlightForCustomer2step">
          <thead>
            <tr>
              <th>Departure location (<a
        ...
        <c:choose>
          ...
          <c:when test="${isRoundTrip}">
            <DT><span class="searchFlightForCustomer3StepTitle">Selecting Returning
            Flight (3 / <c:out value="${totalSteps}" /> steps)</span></DT>
            <DD></DD>
          </c:when>
        </c:choose>
        </p>
      ...
      <%-- step 3/3 --%>
      <c:when test="${step3}">
        <DT><span class="searchFlightForCustomer2StepTitle">Selected Departing Flight (2
        / <c:out value="${totalSteps}" /> steps)</span></DT>
        <DD>
        <table border="1" class="searchFlightForCustomer2step">
          <thead>
        ...
        <DT><span class="searchFlightForCustomer3StepTitle">Choose Returning Flight (3 /
        <c:out value="${totalSteps}" /> steps)</span></DT>
        <DD>
