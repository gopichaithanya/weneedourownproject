...
public class ItineraryManagerTest {
   ...
   public void testTicketNum() {
      /*
       * Once the credit card is validated,
       * the traveler will be shown with the actual ticket information.
       * The ticket number is automatically generated by the application
       * in the format of XX-FFF-YYYYYY-ZZZ,
       * where XX is the airline code,
       * FF is the 3-digit flight number,
       * YYYYYY is the traveler’s login name,
       * and ZZZ is a 3-digit sequence number generated by the application.
